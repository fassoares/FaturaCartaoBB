...
$fileExist = $_FILES['arquivoTxt']['tmp_name'];
echo($fileExist);
...
$fileArq = "C:\Users\\chico\\OneDrive\\Documents\\temp\\fatura cartao maio 2021.csv"; 
//$arrayDatos = array();
if (file_exists($fileExist)){
    ...
    while (!feof($fileName)){
        ...
        if(!$linha==null || $linhaini==""){
            $transacoes = substr($linha,0,50);
            $valor = trim(substr($linha,56,17));
